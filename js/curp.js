...
function obtenerEntidad( entidad ){
    var entidad;
    var vectorEntidades = new Array ( 'DF','AS','BC','BS','CC','CL','CM','CS','CH','DG','GT','GR','HG','JC','MC','MN',
...
function obtenerCURP( nombre, primerApellido,segundoApellido, fecha, genero, entidad ){
